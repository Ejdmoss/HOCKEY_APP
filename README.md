...
Tato aplikace přináší uživatelům snadný a přehledný způsob, jak sledovat vše důležité o jejich oblíbených hokejových týmech hrajících v české Tipsport extralize. Využitím moderních technologií, jako je Flutter a Firebase, zajišťuje spolehlivost, rychlost a multiplatformní dostupnost. Do budoucna plánuju přidání dalších funkcí, jako jsou notifikace, detailnější statistiky hráčů nebo živé aktualizace výsledků. Cílem bylo vytvořit nástroj, který uspokojí potřeby každého hokejového fanouška.
